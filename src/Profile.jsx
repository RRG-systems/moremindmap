...
function extractBosSection(visibleText, keywords, maxLength = 620) {
...
function buildBosTranslatorExcerptFromRenderedProfile(html, profileId) {
  const visibleText = cleanVisibleProfileText(visibleTextFromHtml(html, 12000));
  const sections = [
    {
      title: "Behavior Operating System summary",
      keywords: ["Behavioral Intelligence Profile", "Personal Operating Profile", "Your Behavioral Profile"]
    },
    {
      title: "Core Operating Style",
      keywords: ["primary pattern", "secondary pattern", "operating style", "primary drivers"]
    },
    {
      title: "Behavioral Advantages",
      keywords: ["natural advantage", "strength", "advantage", "primary drivers"]
    },
    {
      title: "Behavioral Risks",
      keywords: ["natural risk", "risk", "de-prioritized", "constraints", "wrong-seat"]
    },
    {
      title: "Pressure Pattern",
      keywords: ["pressure", "under pressure", "stress", "strained"]
    },
    {
      title: "Communication Style",
      keywords: ["communication", "how others", "others experience", "message"]
    },
    {
      title: "Decision Style",
      keywords: ["decision", "decide", "clarity"]
    },
    {
      title: "Execution Pattern",
      keywords: ["execution", "follow-through", "systems", "fidelity"]
    },
    {
      title: "Growth Edge",
      keywords: ["growth", "scale", "scaling", "edge"]
    },
    {
      title: "Recommended Next Move",
      keywords: ["recommended", "next move", "next step", "one move"]
    },
    {
      title: "Profile DNA / DNA Summary",
      keywords: ["profile dna", "dna", "behavioral dna"]
    }
  ];

  const structuredSections = sections
    .map((section) => {
      const body = extractBosSection(visibleText, section.keywords);
      return body ? `${section.title}:\n${body}` : "";
    })
    .filter(Boolean);

  const fallback = visibleText.slice(0, 1800);
  return [
    "Profile context:",
