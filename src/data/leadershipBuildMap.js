export const leadershipBuildMap = [
  ...
  },
  {
    ...
    limits: 'The system records evidence, summarizes sessions, assesses future movement with bands, and creates pending-review drafts. It does not automatically replace the active strategy, use numeric future probabilities, create subscription behavior, Stripe behavior, or RRG runtime.'
  },
  {
    ...
    currentTruth: 'Darren Strategy Chat Foundation is live. Chat Action Proposal Contract is live. Confirmed Chat Action Capture is live. Confirmed writes are limited to One Move status and Outcome Ledger routes. Automatic learning: not live yet.',
  ...
  },
  {
    ...
    currentTruth: "Adaptive Strategy Loop v0 is live. It creates separate summary, movement assessment, and pending-review draft artifacts. It does not replace Darren's active strategy automatically. Automatic learning: not live yet.",
