...
export const WALLY_VISUAL_DNA_SAMPLE = {
  profileId: 'mm-20990103-labsyn03',
  name: 'Rowan Field',
  company: 'Northstar Workshop',
  type: 'Context/Precision',
  primaryEngine: 'Signal',
  secondaryEngine: 'Fidelity',
  engineLabel: 'Context + Precision',
  systemType: 'Evidence Navigation System',
  topDimensions: [
    { label: 'Signal', key: 'SIG', value: 0.81 },
    { label: 'Fidelity', key: 'FID', value: 0.69 },
    { label: 'Flex', key: 'FLE', value: 0.66 },
    { label: 'Horizon', key: 'HOR', value: 0.63 },
    { label: 'Vector', key: 'VEC', value: 0.58 },
    { label: 'Velocity', key: 'VEL', value: 0.47 },
  ],
  lowestDimension: { label: 'Velocity', key: 'VEL', value: 0.47 },
  futureBottleneck: 'Careful review remains concentrated with the owner instead of becoming visible acceptance criteria.',
  oneMove: 'Turn Quality Judgment Into Acceptance Criteria',
  roleTruth: 'Protect contextual awareness while making routine quality decisions transferable.',
  wrongSeatRisk: 'Moderate',
  inputs: ['Client Context', 'Evidence', 'Quality Signals', 'Constraints'],
  operatingLoop: ['Observe', 'Clarify', 'Decide', 'Document', 'Review'],
  outputs: ['Acceptance Criteria', 'Decisions', 'Handoffs', 'Learning'],
  evolutionPath: 'Context-sensitive judgment becomes a compact operating standard.',
  confidence: 'Moderate',
};

export const MARCUS_VISUAL_DNA_SAMPLE = {
  profileId: 'mm-20990104-labsyn04',
  name: 'Marcus Vale',
