...
export const LIVING_CONVERSATION_DERIVED_PROVIDER_REFERENCE =
  'MORE_PRIVATE_RUNTIME_DERIVED_CONVERSATION_PROVIDER_BINDING_V1';
...
export const LIVING_CONVERSATION_PROVIDER_MODEL_VARIABLE = 'OPENAI_MODEL';
export const LIVING_CONVERSATION_PROVIDER_PRIVACY_VARIABLE =
  'MORE_PRIVATE_RUNTIME_CONVERSATION_PROVIDER_PRIVACY_MODE';
