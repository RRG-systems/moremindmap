...
export const SUBSCRIPTION_DEMO_SUBJECT_IDS = Object.freeze(['synthetic']);

const RELATIONSHIP_KEY_PATTERN = /^rel_[a-f0-9]{20}$/u;

export function hasDarrenDemoAuthority(capability) {
  return capability?.contract === 'subscription_v1_internal_capability_v2'
    ...
    && capability.allowed_demo_subjects?.includes('synthetic');
}

export function hasDarrenDemoSubjectAuthority() {
  return false;
}
