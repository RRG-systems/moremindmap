...
import { isSha256, normalizeProfileId as normalizeNewBaProfileId, sha256Stable } from '../newBaProductionReadinessV1/stable.js';
...
function assertCanonicalLineage(artifact, realizationIdentity = null) {
...
function assertPaidBusinessScope(scope, assessmentId, verticalBindingSha256) {
...
function completedRealization(record, profileId, suppliedAssessmentId = null) {
  ...
  return { artifact, assessment_id: assessmentId, created_at: canonicalTimestamp(record.created_at, 'PAID_SUBSCRIBER_REALIZATION_TIMESTAMP_REQUIRED') };
}

function completedBosFusionAuthority(record, {
  profileId,
  baArtifact,
  baHashes,
  baIdentity,
