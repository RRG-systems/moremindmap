import { loadLatestDarrenFutureMovementAssessment } from './darren-adaptive-loop-core.js';
...
export default async function handler(req, res) {
  ...
  try {
    const assessment = await loadLatestDarrenFutureMovementAssessment();
    ...
    return res.status(500).json({ ok: false, error: 'darren_future_movement_unavailable' });
  }
}
