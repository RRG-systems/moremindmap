...
| Accountant | Nora Bell | mm-20260529-acc2f9d6 | Leverage 2.00<br>Vector 1.00<br>Fidelity 0.82 | Flex 0.42<br>Velocity -0.50 | Leverage | Strong accountant fit; risk rises in roles demanding constant ambiguous tradeoffs. | Only 1/3 intended top dimensions landed in top 3. |
| Engineer | Ishan Mehta | mm-20260529-eng7v5k3 | Leverage 2.00<br>Vector 1.00<br>Fidelity 0.81 | Signal 0.43<br>Velocity -0.50 | Leverage | Strong engineer fit; leadership fit improves when translation cadence is explicit. | Only 1/3 intended top dimensions landed in top 3. |
...
| Marketing Creative | Ari Vaughn | mm-20260529-mkc9r4t1 | Vector 2.00<br>Signal 0.88<br>Flex 0.78 | Velocity 0.33<br>Framework -0.50 | Vector | Strong marketing creative fit, with production structure needed near launch. | Only 1/3 intended top dimensions landed in top 3. |
| Compliance Officer | Evelyn Park | mm-20260529-cmp3j6z7 | Leverage 2.00<br>Fidelity 0.81<br>Framework 0.77 | Flex 0.17<br>Velocity -0.50 | Leverage | Strong compliance fit; best when policy guidance is tiered by risk severity. | Top dimensions leverage, fidelity, framework broadly match intended role signal; bottom dimensions flex, velocity create plausible fatigue/risk. |
| Project Manager | Caleb Ruiz | mm-20260529-pjm8d2x5 | Leverage 2.00<br>Vector 1.00<br>Signal 0.82 | Horizon 0.38<br>Velocity -0.50 | Leverage | Strong project manager fit; needs escalation rights to avoid becoming the buffer. | Only 1/3 intended top dimensions landed in top 3. |
...
- Top 3 dimensions: Leverage 2.00, Vector 1.00, Fidelity 0.82
- Bottom 2 dimensions: Flex 0.42, Velocity -0.50
...
- Top 3 dimensions: Leverage 2.00, Vector 1.00, Fidelity 0.81
- Bottom 2 dimensions: Signal 0.43, Velocity -0.50
- Primary engine: Leverage
...
- Top 3 dimensions: Vector 2.00, Signal 0.88, Flex 0.78
- Bottom 2 dimensions: Velocity 0.33, Framework -0.50
- Primary engine: Vector
...
- Top 3 dimensions: Leverage 2.00, Fidelity 0.81, Framework 0.77
- Bottom 2 dimensions: Flex 0.17, Velocity -0.50
- Primary engine: Leverage
...
- Notes on whether scoring feels correct: Top dimensions leverage, fidelity, framework broadly match intended role signal; bottom dimensions flex, velocity create plausible fatigue/risk.
...
- Top 3 dimensions: Leverage 2.00, Vector 1.00, Signal 0.82
- Bottom 2 dimensions: Horizon 0.38, Velocity -0.50
- Primary engine: Leverage
...
- Does the Accountant score differently from the CEO? PASS - Accountant primary Leverage; Founder / CEO primary Vector.
- Does the Recruiter score differently from the Engineer? PASS - Recruiter primary Signal; Engineer primary Leverage.
...
- Does the Marketing Creative show creative signal/adaptability? PASS - top dimensions include one of flex, signal, horizon (vector, signal, flex).
- Does any archetype collapse into generic Command/operator language? WARN - repeated signatures: Leverage/Vector/Fidelity: Accountant, Engineer.
...
- Accountant: Only 1/3 intended top dimensions landed in top 3.
- Engineer: Only 1/3 intended top dimensions landed in top 3.
- Marketing Creative: Only 1/3 intended top dimensions landed in top 3.
- Project Manager: Only 1/3 intended top dimensions landed in top 3.
